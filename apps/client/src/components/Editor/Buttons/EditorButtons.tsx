...
export const Cross = ({ ...props }: EditorButton) => {
  return (
    <button {...props}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const Italic = ({ ...props }: EditorButton) => {
  return (
    <button {...props}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const Underline = ({ ...props }: EditorButton) => {
  return (
    <button {...props}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const AlignLeft = ({ ...props }: EditorButton) => {
  return (
    <button {...props}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const AlignCenter = ({ ...props }: EditorButton) => {
  return (
    <button {...props}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const AlignRight = ({ ...props }: EditorButton) => {
  return (
    <button {...props}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const Justify = ({ ...props }: EditorButton) => {
  return (
    <button {...props}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const Save = ({ ...props }: EditorButton) => {
  return (
    <button {...props}>
